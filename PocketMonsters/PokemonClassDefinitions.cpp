...
void Pokemon::setMoveVector(int number)
{
	moveListSelectionPrivate(local_move_list_ ,number);
}
...
void Pokemon::moveListSelectionPrivate(vector<MoveList> &move_class, int &number)
{
	if (number == 1)
	{
